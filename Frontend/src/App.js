...
function App() {
  ...
  const handleTextCompletion = async () => {
    try {
      const response = await axios.post('backend-textai.vercel.app/complete', { userPrompt : inputText });
  ...
  const handleTextSummarize = async () => {
    try {
      const response = await axios.post('backend-textai.vercel.app/summarize', { userPrompt : inputText });
      setCompletedText(response.data.completedText);
    } catch (error) {
  ...
  const handleTextAnswer = async () => {
    try {
      const response = await axios.post('backend-textai.vercel.app/answer', { userPrompt : inputText });
      setCompletedText(response.data.completedText);
    } catch (error) {
  ...
  const textEmbedding = async () => {
    try {
      const response = await axios.post('backend-textai.vercel.app/embedtext', { userPrompt : inputText });
